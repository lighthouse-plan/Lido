odoo.define('web.test.x2many', function (require) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        trigger: 'tr:has(td:containsExact(山田 太郎)) .o_list_record_selector input[type="checkbox"]'
    }, {
        content: "save selected participants",
        trigger: '.o_select_button',
        extra_trigger: 'tr:has(td:containsExact(山田 太郎)) .o_list_record_selector input[type="checkbox"]:propChecked',
    }, { // save
        content: "save discussion",
        trigger: 'button.o_form_button_save',
        extra_trigger: '.o_form_sheet .tab-pane:eq(2) .o_field_widget tbody tr:has(td:containsExact(山田 太郎))',
    }, { // edit
        ...
        extra_trigger: '.o_web_client:has(textarea[name="message_concat"]:propValue([test] 山田 太郎:a))',
    }, {
        ...
        content: "insert content",
        trigger: 'input.o_required_modifier',
        extra_trigger: 'textarea[name="message_concat"]:first:propValue([test] 山田 太郎:a\n[test] 山田 太郎:b)',
        ...
        trigger: 'textarea[name="message_concat"]:first:propValue([test_trigger] 山田 太郎:a\n[test_trigger] 山田 太郎:b)',
        run: function () {},
    }, { // change message b
        ...
        trigger: '.tab-pane:eq(0) .o_field_x2many_list_row_add a',
        extra_trigger: 'textarea[name="message_concat"]:propValue([test_trigger] 山田 太郎:a\n[test_trigger] 山田 太郎:bbb)',
    }, {
        content: "insert body",
        trigger: 'textarea[name="body"]:first',
        run: 'text c',
        ...
        trigger: '.o_content:has(.tab-pane:eq(0) .o_field_widget tr:has(td:containsExact(bbb)):has(td:containsExact([test_trigger] 山田 太郎)))',
        run: function () {}, // it's a check
    }, {
        ...
        trigger: 'textarea[name="message_concat"]:first:propValueContains([test_trigger] 山田 太郎:e)',
        in_modal: false,
        ...
        trigger: '.o_content:has(.tab-pane:eq(0) .o_field_widget tbody tr:has(td:containsExact([test_trigger] 山田 太郎)):has(td:containsExact(aaa)))',
        run: function () {}, // it's a check
    }, {
        ...
        trigger: 'textarea[name="message_concat"]:propValueContains([test_trigger] 山田 太郎:aaa\n[test_trigger] 山田 太郎:c\n[test_trigger] 山田 太郎:d\n[test_trigger] Marc Demo:ddd)',
        run: function () {}, // don't change texarea content
    }, {
...

    {
        ...
        trigger: '.o_content:not(:has(textarea[name="message_concat"]:propValueContains(山田 太郎:d)))',
        run: function () {},
    }, { // save
        content: "save discussion",
        trigger: 'button.o_form_button_save',
        ...
        trigger: '.o_field_text:containsExact([test_trigger2] 山田 太郎:aaa\n[test_trigger2] Marc Demo:ccccc)',
        run: function () {}, // don't change texarea content
    }, {
        ...
        trigger: '.o_field_text[name="message_concat"]:containsExact([test_trigger2] 山田 太郎:aaa\n[test_trigger2] Marc Demo:ccccc\n[test_trigger2] 山田 太郎:eee)',
        run: function () {}, // it's a check
    }, {
